    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (restart)
            {
                ...
                while (gameEnd)
                {
                    // 점수 계산 ( 코인 획득시 1000점 ) + ( 1회 이동 시 50점 )
                    nowScore = ((coinCount * 1000) - 1000) + (moveCount * 50);
                    ...
                    for (int i = 0; i < enemyCount; i++)
                    {
                        if ((User_Position_Y == enemyPostion_Y[i]) && (User_Position_X == enemyPostion_X[i]))
                        {
                            while (isMeetEnemy)
                            {
                                ...
                                Console.WriteLine("다시 시작하시려면 R / 끝내시려면 Q를 누르세요.");

                                ConsoleKey userInput_ = Console.ReadKey(true).Key;

                                // 재시작 수락
                                if (userInput_ == ConsoleKey.R)
                                {
                                    ...
                                    Console.WriteLine("아무키나 눌러 재시작하세요. ");

                                    // 게임 종료 후 현재 점수와 최대 점수 비교
                                    if ((nowScore > maxScore) && (maxScore == 0))
                                    {
                                        maxScore = nowScore;
                                    }
                                ...
                                // 재시작 거부
                                else if (userInput_ == ConsoleKey.Q)
                                {
                    ...
                    // 플레이어가 움직입니다.
                    User_Move(ref map, ref User_Position_Y, ref User_Position_X, mapSize, ref coinCount, ref enemyPostion_Y, ref enemyPostion_X, ref enemyCount);
        ...
        // 플레이어 이동
        static void User_Move(ref string[,] map, ref int User_Position_Y, ref int User_Position_X, int mapSize, ref int coinCount, ref List<int> enemyPostion_Y, ref List<int> enemyPostion_X, ref int enemyCount)
        {
            ...
            {
                Swap_Move_A(ref map, ref User_Position_Y, ref User_Position_X, mapSize, ref coinCount, ref enemyPostion_Y, ref enemyPostion_X, ref enemyCount);
            }

            // D 입력 (오른쪽이동)
            else if (user_Move == ConsoleKey.D)
            {
                Swap_Move_D(ref map, ref User_Position_Y, ref User_Position_X, mapSize, ref coinCount, ref enemyPostion_Y, ref enemyPostion_X, ref enemyCount);
            }

            // W 입력 (위쪽이동)
            else if (user_Move == ConsoleKey.W)
            {
                Swap_Move_W(ref map, ref User_Position_Y, ref User_Position_X, mapSize, ref coinCount, ref enemyPostion_Y, ref enemyPostion_X, ref enemyCount);
            }

            // S 입력 (아래쪽이동)
            else if (user_Move == ConsoleKey.S)
            {
                Swap_Move_S(ref map, ref User_Position_Y, ref User_Position_X, mapSize, ref coinCount, ref enemyPostion_Y, ref enemyPostion_X, ref enemyCount);
            }
        }
        // 플레이어 이동 end
        ...
        #region
        // A 이동
        static void Swap_Move_A(ref string[,] map, ref int User_Position_Y, ref int User_Position_X, int mapSize, ref int coinCount, ref List<int> enemyPostion_Y, ref List<int> enemyPostion_X, ref int enemyCount)
        {
            // 벽이 아닐 경우 && 돌이 아닐 경우
            if ((map[User_Position_Y, User_Position_X - 1] != "■") && (map[User_Position_Y, User_Position_X - 1] != "▣"))
            {
                ...
                else if (map[User_Position_Y, User_Position_X - 1] == "◈")
                {
                    ...
                    // 코인을 3개 먹으면 적을 한명 처치합니다.
                    if (coinCount % 3 == 0)
                    {
                        map[enemyPostion_Y[0], enemyPostion_X[0]] = "□";
                        enemyPostion_Y.RemoveAt(0);
                        enemyPostion_X.RemoveAt(0);
                        enemyCount--;
                    }
                }
        ...
        // D 이동
        static void Swap_Move_D(ref string[,] map, ref int User_Position_Y, ref int User_Position_X, int mapSize, ref int coinCount, ref List<int> enemyPostion_Y, ref List<int> enemyPostion_X, ref int enemyCount)
        {
            // 벽이 아닐 경우 && 돌이 아닐 경우
            if ((map[User_Position_Y, User_Position_X + 1] != "■") && (map[User_Position_Y, User_Position_X + 1] != "▣"))
            {
        ...
        // W 이동
        static void Swap_Move_W(ref string[,] map, ref int User_Position_Y, ref int User_Position_X, int mapSize, ref int coinCount, ref List<int> enemyPostion_Y, ref List<int> enemyPostion_X, ref int enemyCount)
        {
            // 벽이 아닐 경우 && 돌이 아닐 경우
        ...
        // S 이동
        static void Swap_Move_S(ref string[,] map, ref int User_Position_Y, ref int User_Position_X, int mapSize, ref int coinCount, ref List<int> enemyPostion_Y, ref List<int> enemyPostion_X, ref int enemyCount)
        {
            // 벽이 아닐 경우 && 돌이 아닐 경우
            if ((map[User_Position_Y + 1, User_Position_X] != "■") && (map[User_Position_Y + 1, User_Position_X] != "▣"))
            {
